...
const periods = ["9:00-9:50 AM", "9:50-10:40 AM", "10:40-11:30 AM", "11:30-12:20 PM", 
"1:00-1:50 PM", "1:50-2:40 PM", "2:40-3:30 PM"]; 
...
line.includes(":")); 
  ...
  for (let daySchedule of schedule) { 
    ...
    for (let slot of daySchedule.periods) { 
      html += `<td><strong>${slot.subject}</strong><br/>${slot.teacher}<br/>Room 
${slot.room}</td>`; 
    } 
    html += `</tr>`; 
  } 
